...
public class SkywarsScoreboard {
    ...
    public void lobbyScoreboard(final SkywarsPlayer player) {
        ...
        header.setPrefix("");
        header.setSuffix("");
        objective.getScore(Utils.colorize("&7Header :) ")).setScore(5);
        ...
        objective.getScore(Utils.colorize("&8Wins: ")).setScore(3);
        ...
        objective.getScore(Utils.colorize("&8Kills: ")).setScore(2);
        ...
        objective.getScore(Utils.colorize("&8Coins: ")).setScore(1);
